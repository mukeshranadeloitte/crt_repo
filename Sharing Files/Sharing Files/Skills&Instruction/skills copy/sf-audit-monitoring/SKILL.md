...
## Audit logging configuration (ruleset ID 36)
...
## Audit log retention (ruleset ID 37)
...
## Audit log access restrictions (ruleset ID 39)
...
## Transaction security policies (ruleset ID 40)
...
## Custom security policy actions (ruleset ID 41)
