...
## MFA and SSO enforcement (ruleset IDs 23, 24)
...
## Account verification link expiry (ruleset ID 25)
...
## Session IP locking (ruleset ID 26)
...
## Session timeout and account lockout (ruleset ID 27)
...
## Session token security (ruleset IDs 28–30)
