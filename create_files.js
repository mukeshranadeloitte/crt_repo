...
// File 1 path and content
const file1Path = 'c:/Users/mukerana/Documents/VS_Code/github_repo/crt_repo/.github/agents/e2e-uat-pipeline.agent.md';
const file1Content = `---
...
// File 2 path and content
const file2Path = 'c:/Users/mukerana/Documents/VS_Code/github_repo/crt_repo/.github/prompts/create-e2e-uat-pipeline.prompt.md';
const file2Content = `---
...
const dir1 = path.dirname(file1Path);
const dir2 = path.dirname(file2Path);
...
try {
  ...
  console.log('✓ Created file: ' + file1Path);
  console.log('  Size: ' + file1Content.length + ' bytes');
  
  // Write File 2
  fs.writeFileSync(file2Path, file2Content, 'utf8');
  console.log('✓ Created file: ' + file2Path);
  console.log('  Size: ' + file2Content.length + ' bytes');
